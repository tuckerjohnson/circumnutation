  ...
  \new Staff = "u" {
    <<
      \relative { \tmarkfi \override Hairpin.to-barline = ##f %\tempo Lento 4=40
        ...
        \time 6/4
        \stemNeutral <b' e a>2\arpeggio\mf^\markup { \smaller \italic "dolce; espr." } fis'4(~\p \tuplet 3/2 { fis8 <f, c'>4)\<\arpeggio } <cis dis' gis>2\arpeggio |
      ...
      \relative { %\tmarkfi
        ...
        #(lambda (grob)
          (ly:stencil-combine-at-edge
            ...
            X RIGHT
            (grob-interpret-markup grob nine-barlineMarkup) 0
          )
        )
        \bar "|."
      }
