...
\time 15/8 \change Staff = "di1" \stemUp gis8[\laissezVibrer\sustainOn a\laissezVibrer cis\laissezVibrer \change Staff = "ui1" fis\laissezVibrer \change Staff = "di1" b,\laissezVibrer dis,\laissezVibrer e,\laissezVibrer] \change Staff = "ui1" \override NoteHead #'no-ledgers = ##t \override NoteHead.transparent = ##t b''1*1/2^~ 1*1/2 \offset X-offset #-3.4 \fermata^\markup { \tiny \italic "go on when it should" } \override NoteHead.transparent = ##f \override NoteHead #'no-ledgers = ##f |
...
\time 15/8 \set Staff.pedalSustainStyle = #'bracket \override NoteHead.transparent = ##t \change Staff = "ui1" s4. \offset Y-offset #1 ^\markup { \tiny \italic "ad lib" } \change Staff = "di1" s4 s4 d'1*1/2_~ 1*1/2 |
s4.\sustainOff\sustainOn s4 s4 d1*1/2_~ 1*1/2 |
s4.\sustainOff\sustainOn s4 s4 d1*1/2_~ 1*1/2 |
s4.\sustainOff\sustainOn s4 s4 d1*1/2_~ 1*1/2 |
s4.\sustainOff\sustainOn s4 s4 d1*1/2_~ 1*1/2 |
s4.\sustainOff\sustainOn s4 s4 d1*1/2_~ 1*1/2 |
\time 7/8 \override TextSpanner.bound-details.left.text = "poco accel." \change Staff = "ui1" s8\startTextSpan s8 s8 s8 s8 s8 s8\stopTextSpan \offset X-offset 0 ^\markup {"attacca"} | }
