...
\time 7/8 c'8[\offset X-offset #-2.5 \offset Y-offset #-2 \mp d-- e f->-. \change Staff = "di2" g,-. a-. b-.] |
...
s1*7/8 |
s4 \utwo \stemUp g8^([ a8^.]^) \dtwo \stemDown bes,,4_( d8_._) |
s1*7/8 |
s4. s4  c'4_( |
b8_._) cis8_([ d8_.]_) s8 s4. |
s1*7/8 |
g,,4._( c8_._) s8 \utwo \stemUp ees'''8^([ f8^.]^) |
s1*7/8 |
...
s1*7/8 |
\utwo s4 \stemUp a'8~[ b~] <a b>4. \dtwo | \revert Staff.BarLine.stencil }
