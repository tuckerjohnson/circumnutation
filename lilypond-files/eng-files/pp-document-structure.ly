...
\score {
\header {
instrument = \markup { \italic "sequence" \number 5 \smaller \medium \italic " (sunwise)" }
...
\accidentalStyle modern
<<
\relative \voiceAithrteen
\\
\relative \voiceBithrteen
>>
}
\new Staff = "di13" { \clef bass
\accidentalStyle modern
<<
\relative \voiceCithrteen
\\
\relative \voiceDithrteen
\\
\relative \voiceEithrteen
>>
}
>>
%\midi { }
